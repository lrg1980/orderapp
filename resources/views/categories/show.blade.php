            ...
            <div class="row">
                <div class="profile">
                    <div class="avatar">
                        ...
                        <img src="{{ $category->featured_image_url }}" alt="Imagen de categoria {{ $category->name }}"     class="img-thumbnail img-responsive img-raised">
                    </div>

                    <div class="name">
                        <h3 class="title">Categoría {{ $category->name }}</h3>                        
                    </div>
                </div>
            </div>
